...
if __name__ == "__main__":
    ...
    if args.rerun:
        ...
        weight_matrix = spk_train.weight_matrix + np.diag([-1]*N)
        print("weight matrix", weight_matrix)
        N, Nt = 64, 2000000
        spk_train = simulate_spk_train(N=N, Nt=Nt, weight_matrix=weight_matrix, baseline=-2, weight_factor=0.9, filename=f"spk_train_{N}_{Nt}_b_-2_-1_diag")
